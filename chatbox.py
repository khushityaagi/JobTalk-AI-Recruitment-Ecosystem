...
# NOTE: You will need to put your free API key here!
client = genai.Client(api_key="put your unique key")
...
def get_chatbot_response(query, resume_text, skills):
    ...
    try:
        ...
        return response.text.replace('*', '') # Clean up markdown formatting for HTML
